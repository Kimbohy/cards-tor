import Nav from "../Nav";
import BicycleImage from "./BicycleImage";

const Hero = () => {
  return (
    <section className="min-h-screen w-full relative hero text-white flex flex-col justify-center p-4 sm:p-6 md:p-9 bg-[url('/images/bg-hero.jpg')] dark:bg-[url('/images/bg-hero-dark.jpg')] bg-no-repeat bg-cover">
      <div className="text-5xl sm:text-5xl md:text-6xl text-secondary-foreground lg:text-7xl xl:text-8xl md:mt-24 mt-20 md:flex-1 font-serif text-center px-4">
