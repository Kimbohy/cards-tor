      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-light mb-4 sm:mb-6 text-foreground">
                Our Story of Excellence
              </h2>
              <div className="w-20 sm:w-24 h-1 bg-accent mb-6 sm:mb-8"></div>
            </div>
            ...
            <div className="pt-2 sm:pt-4">
              <div className="inline-block border border-accent/30 px-4 sm:px-6 py-2 sm:py-3">
                <p className="text-accent font-serif italic text-sm sm:text-base md:text-lg">
