...
export default function FAQ() {
  return (
    <section id="FAQ" className="py-24 bg-background text-foreground">
        ...
        <Accordion type="single" collapsible className="w-full space-y-6 ">
          {faqs.map((faq, index) => (
            <AccordionItem
              key={index}
              value={`item-${index}`}
              className="bg-card border border-border rounded-lg px-8 py-4 hover:border-primary backdrop-blur-sm"
            >
